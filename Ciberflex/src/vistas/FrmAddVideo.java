...
public class FrmAddVideo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmAddVideo frame = new FrmAddVideo();
	...
	void peliculaovideo(){
		tipo = String.valueOf(FrmAddContenido.cboTipo.getSelectedItem());
	...
	void guardar(){
		...
		if(errors == 0){
			...
			FrmAddContenido.actualizarListaVideos(fila);
			dispose();
		}
